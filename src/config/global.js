export default {
  ...
  complementario: [
    {
      ...
      tipo: 'Guía PDF',
      link:
        'https://www.mincit.gov.co/prensa/noticias/comercio/se-consolida-crecimiento-exportaciones-nme',
    },
    {
      tema: 'Incoterms',
      referencia:
      ...
      tipo: 'Video',
      link: 'https://www.youtube.com/watch?v=DN4syzxRt_U&t=17s',
    },
    {
    ...
    },
    {
      ...
      tipo: 'Artículo',
      link:
        'https://procolombia.co/sites/default/files/2024-05/_servicios21-11-2018.pdf  ',
    },
  ],
  glosario: [
    {
  ...
  referencias: [
    ...
    },
    {
      ...
      link:
        'https://procolombia.co/colombiatrade/exportador/articulos/como-exportar-servicios-desde-colombia',
    },
    {
      referencia:
